...
the [user controller](https://github.com/ImSonu2030/System-Software/blob/master/controller/user.h)
...
- the types of requests and their required data can be seen in [request.h](https://github.com/ImSonu2030/System-Software/blob/master/model/request.h)
...
## class diagram
![class_diagram.png](https://github.com/ImSonu2030/System-Software/blob/master/class_diagram.png?raw=true)
